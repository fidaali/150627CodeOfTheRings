...
public class SuffixTool {
    ...
    public static class AbstractSuffixTree {
    ...
    public static class SimpleSuffixTree extends AbstractSuffixTree {
    ...
    public static class CompactSuffixTree extends AbstractSuffixTree {
        ...
        private SuffixTreeNode compactNodes(SuffixTreeNode node, int nodeDepth) {
            ...
            for (SuffixTreeNode child : node.children) {
                while (child.children.size() == 1) {
                    ...
                    for (SuffixTool.SuffixTreeNode grandchildAll : child.children) {
                        grandchildAll.parent = node;
                    }
                }
    ...
    public static class SuffixTreeEdge extends SuffixTool.SuffixTreeNode {
